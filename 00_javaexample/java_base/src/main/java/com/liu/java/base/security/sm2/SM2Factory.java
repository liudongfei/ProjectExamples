...
public class SM2Factory {
    ...
    public SM2Factory() {
        ...
        this.eccGxFieldElement = new Fp(this.p,this.gx);
        this.eccGyFieldElement = new Fp(this.p, this.gy);

        this.eccCurve = new ECCurve.Fp(this.p, this.a, this.b);

        this.eccPointG = new ECPoint.Fp(this.eccCurve, this.eccGxFieldElement,this.eccGyFieldElement);
        this.eccBcSpec = new ECDomainParameters(this.eccCurve, this.eccPointG, this.n);

        ECKeyGenerationParameters ecc_ecgenparam;
        ecc_ecgenparam = new ECKeyGenerationParameters(this.eccBcSpec, new SecureRandom());
    ...
    public void sm2Verify(byte[] md, ECPoint userKey, BigInteger r, BigInteger s, SM2Result sm2Result) {
        ...
        if (t.equals(BigInteger.ZERO)) {
            ...
            ECPoint x1y1 = eccPointG.multiply(sm2Result.s);
