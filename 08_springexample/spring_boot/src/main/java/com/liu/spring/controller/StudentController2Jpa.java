...
import com.liu.spring.repository.StudentRespository;
...
/**
 * 对student进行操作的controller,datajpa.
 * @Auther: liudongfei
 * @Date: 2019/10/9 10:34
 * @Description:
 */
@Controller
public class StudentController2Jpa {
    @Autowired
    ...
    public String queryStudents() throws JsonProcessingException {
        ...
        if (null == userListData) {
            //查询数据库获得数据
            List<Student> all = studentRespository.findAll();
            //转换成json格式字符串
